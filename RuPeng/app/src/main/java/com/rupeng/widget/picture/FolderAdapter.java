...
public class FolderAdapter extends BaseAdapter{
    ...
    public FolderAdapter(Context context){
        ...
        mImageSize = mContext.getResources().getDimensionPixelOffset(R.dimen.de_pic_folder_cover_size);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ViewHolder holder;
        if(view == null){
            view = mInflater.inflate(R.layout.rc_pic_item_folder, viewGroup, false);
            ...
            if(i == 0){
                ...
                if(mFolders.size()>0){
                    ...
                    Picasso.with(mContext)
                            ...
                            .error(R.drawable.de_pic_default_error)
